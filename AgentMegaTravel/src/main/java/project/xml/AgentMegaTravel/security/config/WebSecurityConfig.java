package project.xml.AgentMegaTravel.security.config;
...
import project.xml.AgentMegaTravel.security.auth.RestAuthenticationEntryPoint;
import project.xml.AgentMegaTravel.security.auth.TokenAuthenticationFilter;
	...
	// Implementacija PasswordEncoder-a koriscenjem BCrypt hashing funkcije.
			...
			protected void configure(HttpSecurity http) throws Exception {
				http
					...
					.antMatchers("/ws/*").permitAll()
					.antMatchers("/ws").permitAll()
					//.antMatchers("/api/accommodations/allAccommodationServices").permitAll()
